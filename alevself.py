...
ale = ALEVAN.LINE()
#ale.login(qr=True)
ale.login(token='ErEB3ryDtynZ3xbVYaR7.NJBaaPWX4ChwW2QkFbp+nW.yjGRQvS/nFmPLicSc1jhp3za1WA8iSCI3hAtiRXSegM=')
ale.loginResult()
print "Monika Login Success\n"
...
╚══════════════════
"""
alevan="u9e36c0029c31e1c1d6c36a8a7c13ff37"
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Terima Kasih Telah Menggunakan Jasa Kami :v",
  #  "comment2":"Wkwkwk ＼（○＾ω＾○）／",
#    "comment3":"Lucu Banget!!! ヘ(^_^)ヘ",
#    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like By : Monika\n👉 http://line.me/ti/p/~syifaabyananta",    
    "commentOn":True,
    "commentBlack":{},
...
#              if msg.from_ in Admin:
		...
		if msg.from_ in admin:
		    ...
		    ale.sendText(msg.to, "Khusus Monika")
...
#--------------------------------------------------------
		...
		try:
		    ...
		    ale.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto like by:Monika\nhttp://line.me/ti/p/~syifaabyananta")
